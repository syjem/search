...
// Define the component using the provided props interface
const SearchInput: React.FC<SearchInputProps> = ({ search, handleSearch }) => {
  return (
    <div className="search-bar">
      ...
      >
        <SvgIcon fontSize="large">
          <svg
            className="google-camera-icon"
            focusable="false"
            viewBox="0 0 192 192"
            xmlns="http://www.w3.org/2000/svg"
            aria-label="Google Camera Icon"
          >
